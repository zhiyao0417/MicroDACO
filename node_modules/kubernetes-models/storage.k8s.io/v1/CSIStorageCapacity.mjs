...
import { addSchema } from "../../_schemas/IoK8sApiStorageV1CSIStorageCapacity.mjs";
/**
...
setSchema(CSIStorageCapacity, "io.k8s.api.storage.v1.CSIStorageCapacity", addSchema);
export { CSIStorageCapacity as IoK8sApiStorageV1CSIStorageCapacity };
