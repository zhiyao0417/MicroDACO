...
import { addSchema } from "../../_schemas/IoK8sApiStorageV1beta1CSINodeList.mjs";
/**
...
setSchema(CSINodeList, "io.k8s.api.storage.v1beta1.CSINodeList", addSchema);
export { CSINodeList as IoK8sApiStorageV1beta1CSINodeList };
