...
const IoK8sApiAdmissionregistrationV1beta1ValidatingWebhook_1 = require("./IoK8sApiAdmissionregistrationV1beta1ValidatingWebhook.js");
const schema = {
    "properties": {
        "apiVersion": {
            "type": "string",
...
function addSchema() {
    ...
    (0, IoK8sApiAdmissionregistrationV1beta1ValidatingWebhook_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.admissionregistration.v1beta1.ValidatingWebhookConfiguration", schema);
}
