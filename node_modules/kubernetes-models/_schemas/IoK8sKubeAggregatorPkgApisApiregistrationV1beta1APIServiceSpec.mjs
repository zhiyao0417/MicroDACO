...
import { addSchema as IoK8sKubeAggregatorPkgApisApiregistrationV1beta1ServiceReference } from "./IoK8sKubeAggregatorPkgApisApiregistrationV1beta1ServiceReference.mjs";
const schema = {
    "properties": {
        "caBundle": {
            "format": "byte",
