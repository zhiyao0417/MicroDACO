...
const IoK8sApiStorageV1CSINodeSpec_1 = require("./IoK8sApiStorageV1CSINodeSpec.js");
const schema = {
    "properties": {
        "apiVersion": {
            "type": "string",
...
function addSchema() {
    ...
    (0, IoK8sApiStorageV1CSINodeSpec_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.storage.v1.CSINode", schema);
}
