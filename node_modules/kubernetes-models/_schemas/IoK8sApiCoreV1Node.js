...
const IoK8sApiCoreV1NodeSpec_1 = require("./IoK8sApiCoreV1NodeSpec.js");
const IoK8sApiCoreV1NodeStatus_1 = require("./IoK8sApiCoreV1NodeStatus.js");
const schema = {
    "properties": {
        "apiVersion": {
            "type": "string",
...
function addSchema() {
    ...
    (0, IoK8sApiCoreV1NodeSpec_1.addSchema)();
    (0, IoK8sApiCoreV1NodeStatus_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.core.v1.Node", schema);
}
