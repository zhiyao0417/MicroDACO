...
const IoK8sApiCoreV1PersistentVolumeSpec_1 = require("./IoK8sApiCoreV1PersistentVolumeSpec.js");
const IoK8sApiCoreV1PersistentVolumeStatus_1 = require("./IoK8sApiCoreV1PersistentVolumeStatus.js");
const schema = {
    "properties": {
        "apiVersion": {
            "type": "string",
...
function addSchema() {
    ...
    (0, IoK8sApiCoreV1PersistentVolumeSpec_1.addSchema)();
    (0, IoK8sApiCoreV1PersistentVolumeStatus_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.core.v1.PersistentVolume", schema);
}
