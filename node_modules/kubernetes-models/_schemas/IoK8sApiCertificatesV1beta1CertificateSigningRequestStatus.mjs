...
import { addSchema as IoK8sApiCertificatesV1beta1CertificateSigningRequestCondition } from "./IoK8sApiCertificatesV1beta1CertificateSigningRequestCondition.mjs";
const schema = {
    "properties": {
        "certificate": {
            "format": "byte",
