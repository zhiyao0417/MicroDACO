...
const IoK8sApiRbacV1beta1RoleRef_1 = require("./IoK8sApiRbacV1beta1RoleRef.js");
const IoK8sApiRbacV1beta1Subject_1 = require("./IoK8sApiRbacV1beta1Subject.js");
const schema = {
    "properties": {
        "apiVersion": {
            "type": "string",
...
function addSchema() {
    ...
    (0, IoK8sApiRbacV1beta1RoleRef_1.addSchema)();
    (0, IoK8sApiRbacV1beta1Subject_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.rbac.v1beta1.ClusterRoleBinding", schema);
}
