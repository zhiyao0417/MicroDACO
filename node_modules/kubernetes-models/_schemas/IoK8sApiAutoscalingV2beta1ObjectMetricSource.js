...
const IoK8sApiAutoscalingV2beta1CrossVersionObjectReference_1 = require("./IoK8sApiAutoscalingV2beta1CrossVersionObjectReference.js");
const schema = {
    "properties": {
        "averageValue": {
            "oneOf": [
...
function addSchema() {
    ...
    (0, IoK8sApiAutoscalingV2beta1CrossVersionObjectReference_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.autoscaling.v2beta1.ObjectMetricSource", schema);
}
