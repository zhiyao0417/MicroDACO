...
const IoK8sApiAppsV1beta1StatefulSetUpdateStrategy_1 = require("./IoK8sApiAppsV1beta1StatefulSetUpdateStrategy.js");
const IoK8sApiCoreV1PersistentVolumeClaim_1 = require("./IoK8sApiCoreV1PersistentVolumeClaim.js");
const schema = {
    "properties": {
        "podManagementPolicy": {
            "type": "string",
        ...
        "updateStrategy": {
            "oneOf": [
                {
                    "$ref": "io.k8s.api.apps.v1beta1.StatefulSetUpdateStrategy#"
                },
                {
                    "type": "null"
                }
...
function addSchema() {
    ...
    (0, IoK8sApiAppsV1beta1StatefulSetUpdateStrategy_1.addSchema)();
    (0, IoK8sApiCoreV1PersistentVolumeClaim_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.apps.v1beta1.StatefulSetSpec", schema);
}
