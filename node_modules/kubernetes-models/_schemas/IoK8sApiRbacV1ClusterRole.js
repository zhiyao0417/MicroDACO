...
const IoK8sApiRbacV1AggregationRule_1 = require("./IoK8sApiRbacV1AggregationRule.js");
...
const IoK8sApiRbacV1PolicyRule_1 = require("./IoK8sApiRbacV1PolicyRule.js");
const schema = {
    "properties": {
        "aggregationRule": {
            "oneOf": [
...
function addSchema() {
    (0, IoK8sApiRbacV1AggregationRule_1.addSchema)();
    (0, IoK8sApimachineryPkgApisMetaV1ObjectMeta_1.addSchema)();
    (0, IoK8sApiRbacV1PolicyRule_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.rbac.v1.ClusterRole", schema);
}
