...
const IoK8sApiNetworkingV1beta1IngressSpec_1 = require("./IoK8sApiNetworkingV1beta1IngressSpec.js");
const IoK8sApiNetworkingV1beta1IngressStatus_1 = require("./IoK8sApiNetworkingV1beta1IngressStatus.js");
const schema = {
    "properties": {
        "apiVersion": {
            "type": "string",
...
function addSchema() {
    ...
    (0, IoK8sApiNetworkingV1beta1IngressSpec_1.addSchema)();
    (0, IoK8sApiNetworkingV1beta1IngressStatus_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.networking.v1beta1.Ingress", schema);
}
