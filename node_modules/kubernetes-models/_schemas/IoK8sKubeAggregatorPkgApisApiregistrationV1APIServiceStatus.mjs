...
import { addSchema as IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceCondition } from "./IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceCondition.mjs";
const schema = {
    "properties": {
        "conditions": {
            "items": {
