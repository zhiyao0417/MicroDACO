...
const IoK8sApiAppsV1DeploymentSpec_1 = require("./IoK8sApiAppsV1DeploymentSpec.js");
const IoK8sApiAppsV1DeploymentStatus_1 = require("./IoK8sApiAppsV1DeploymentStatus.js");
const schema = {
    "properties": {
        "apiVersion": {
            "type": "string",
...
function addSchema() {
    ...
    (0, IoK8sApiAppsV1DeploymentSpec_1.addSchema)();
    (0, IoK8sApiAppsV1DeploymentStatus_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.apps.v1.Deployment", schema);
}
