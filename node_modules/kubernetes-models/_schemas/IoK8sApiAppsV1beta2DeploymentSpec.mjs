...
import { addSchema as IoK8sApiAppsV1beta2DeploymentStrategy } from "./IoK8sApiAppsV1beta2DeploymentStrategy.mjs";
...
const schema = {
    "properties": {
        ...
        "strategy": {
            "oneOf": [
                {
                    "$ref": "io.k8s.api.apps.v1beta2.DeploymentStrategy#"
                },
                {
                    "type": "null"
                }
...
export function addSchema() {
    ...
    register("io.k8s.api.apps.v1beta2.DeploymentSpec", schema);
}
