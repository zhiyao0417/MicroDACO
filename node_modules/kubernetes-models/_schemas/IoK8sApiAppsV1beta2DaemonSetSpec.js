...
const IoK8sApiAppsV1beta2DaemonSetUpdateStrategy_1 = require("./IoK8sApiAppsV1beta2DaemonSetUpdateStrategy.js");
const schema = {
    "properties": {
        "minReadySeconds": {
            "format": "int32",
        ...
        "updateStrategy": {
            "oneOf": [
                {
                    "$ref": "io.k8s.api.apps.v1beta2.DaemonSetUpdateStrategy#"
                },
                {
                    "type": "null"
                }
...
function addSchema() {
    ...
    (0, IoK8sApiAppsV1beta2DaemonSetUpdateStrategy_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.apps.v1beta2.DaemonSetSpec", schema);
}
