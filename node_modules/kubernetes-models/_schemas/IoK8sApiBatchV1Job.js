...
const IoK8sApiBatchV1JobSpec_1 = require("./IoK8sApiBatchV1JobSpec.js");
const IoK8sApiBatchV1JobStatus_1 = require("./IoK8sApiBatchV1JobStatus.js");
const schema = {
    "properties": {
        "apiVersion": {
            "type": "string",
...
function addSchema() {
    ...
    (0, IoK8sApiBatchV1JobSpec_1.addSchema)();
    (0, IoK8sApiBatchV1JobStatus_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.batch.v1.Job", schema);
}
