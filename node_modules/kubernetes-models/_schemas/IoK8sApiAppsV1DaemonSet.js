...
const IoK8sApiAppsV1DaemonSetSpec_1 = require("./IoK8sApiAppsV1DaemonSetSpec.js");
const IoK8sApiAppsV1DaemonSetStatus_1 = require("./IoK8sApiAppsV1DaemonSetStatus.js");
const schema = {
    "properties": {
        "apiVersion": {
            "type": "string",
...
function addSchema() {
    ...
    (0, IoK8sApiAppsV1DaemonSetSpec_1.addSchema)();
    (0, IoK8sApiAppsV1DaemonSetStatus_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.apps.v1.DaemonSet", schema);
}
