...
const IoK8sApiExtensionsV1beta1RollbackConfig_1 = require("./IoK8sApiExtensionsV1beta1RollbackConfig.js");
...
const IoK8sApiExtensionsV1beta1DeploymentStrategy_1 = require("./IoK8sApiExtensionsV1beta1DeploymentStrategy.js");
...
const schema = {
    "properties": {
        ...
        "strategy": {
            "oneOf": [
                {
                    "$ref": "io.k8s.api.extensions.v1beta1.DeploymentStrategy#"
                },
                {
                    "type": "null"
                }
...
function addSchema() {
    (0, IoK8sApiExtensionsV1beta1RollbackConfig_1.addSchema)();
    (0, IoK8sApimachineryPkgApisMetaV1LabelSelector_1.addSchema)();
    (0, IoK8sApiExtensionsV1beta1DeploymentStrategy_1.addSchema)();
    (0, IoK8sApiCoreV1PodTemplateSpec_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.extensions.v1beta1.DeploymentSpec", schema);
}
