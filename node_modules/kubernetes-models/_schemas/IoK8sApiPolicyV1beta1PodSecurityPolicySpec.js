...
function addSchema() {
    (0, IoK8sApiPolicyV1beta1AllowedCSIDriver_1.addSchema)();
    (0, IoK8sApiPolicyV1beta1AllowedFlexVolume_1.addSchema)();
    (0, IoK8sApiPolicyV1beta1AllowedHostPath_1.addSchema)();
    (0, IoK8sApiPolicyV1beta1FSGroupStrategyOptions_1.addSchema)();
    (0, IoK8sApiPolicyV1beta1HostPortRange_1.addSchema)();
    (0, IoK8sApiPolicyV1beta1RunAsGroupStrategyOptions_1.addSchema)();
    (0, IoK8sApiPolicyV1beta1RunAsUserStrategyOptions_1.addSchema)();
    (0, IoK8sApiPolicyV1beta1RuntimeClassStrategyOptions_1.addSchema)();
    (0, IoK8sApiPolicyV1beta1SELinuxStrategyOptions_1.addSchema)();
    (0, IoK8sApiPolicyV1beta1SupplementalGroupsStrategyOptions_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.policy.v1beta1.PodSecurityPolicySpec", schema);
}
