...
const IoK8sApiAppsV1DeploymentStrategy_1 = require("./IoK8sApiAppsV1DeploymentStrategy.js");
...
function addSchema() {
    ...
    (0, IoK8sApiAppsV1DeploymentStrategy_1.addSchema)();
    (0, IoK8sApiCoreV1PodTemplateSpec_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.apps.v1.DeploymentSpec", schema);
}
