...
const IoK8sApiCoreV1PodSpec_1 = require("./IoK8sApiCoreV1PodSpec.js");
const IoK8sApiCoreV1PodStatus_1 = require("./IoK8sApiCoreV1PodStatus.js");
const schema = {
    "properties": {
        "apiVersion": {
            "type": "string",
...
function addSchema() {
    ...
    (0, IoK8sApiCoreV1PodSpec_1.addSchema)();
    (0, IoK8sApiCoreV1PodStatus_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.core.v1.Pod", schema);
}
