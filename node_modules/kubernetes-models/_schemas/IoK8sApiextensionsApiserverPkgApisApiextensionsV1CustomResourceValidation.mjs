...
import { addSchema as IoK8sApiextensionsApiserverPkgApisApiextensionsV1JSONSchemaProps } from "./IoK8sApiextensionsApiserverPkgApisApiextensionsV1JSONSchemaProps.mjs";
const schema = {
    "properties": {
        "openAPIV3Schema": {
            "oneOf": [
