...
const IoK8sApiBatchV1beta1CronJobSpec_1 = require("./IoK8sApiBatchV1beta1CronJobSpec.js");
const IoK8sApiBatchV1beta1CronJobStatus_1 = require("./IoK8sApiBatchV1beta1CronJobStatus.js");
const schema = {
    "properties": {
        "apiVersion": {
            "type": "string",
...
function addSchema() {
    ...
    (0, IoK8sApiBatchV1beta1CronJobSpec_1.addSchema)();
    (0, IoK8sApiBatchV1beta1CronJobStatus_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.batch.v1beta1.CronJob", schema);
}
