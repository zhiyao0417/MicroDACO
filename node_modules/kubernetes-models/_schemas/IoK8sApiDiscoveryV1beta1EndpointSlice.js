...
const IoK8sApiDiscoveryV1beta1Endpoint_1 = require("./IoK8sApiDiscoveryV1beta1Endpoint.js");
...
const IoK8sApiDiscoveryV1beta1EndpointPort_1 = require("./IoK8sApiDiscoveryV1beta1EndpointPort.js");
const schema = {
    "properties": {
        "addressType": {
            "type": "string"
...
function addSchema() {
    (0, IoK8sApiDiscoveryV1beta1Endpoint_1.addSchema)();
    (0, IoK8sApimachineryPkgApisMetaV1ObjectMeta_1.addSchema)();
    (0, IoK8sApiDiscoveryV1beta1EndpointPort_1.addSchema)();
    (0, validate_1.register)("io.k8s.api.discovery.v1beta1.EndpointSlice", schema);
}
