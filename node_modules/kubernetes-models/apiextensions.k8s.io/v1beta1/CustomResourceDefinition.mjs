...
import { addSchema } from "../../_schemas/IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition.mjs";
/**
 ...
 * @deprecated
 */
export class CustomResourceDefinition extends Model {
    constructor(data) {
        super({
...
CustomResourceDefinition.is = createTypeMetaGuard(CustomResourceDefinition);
setSchema(CustomResourceDefinition, "io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.CustomResourceDefinition", addSchema);
export { CustomResourceDefinition as IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinition };
