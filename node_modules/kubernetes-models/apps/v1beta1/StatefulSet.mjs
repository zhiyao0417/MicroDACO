...
import { addSchema } from "../../_schemas/IoK8sApiAppsV1beta1StatefulSet.mjs";
/**
...
setSchema(StatefulSet, "io.k8s.api.apps.v1beta1.StatefulSet", addSchema);
export { StatefulSet as IoK8sApiAppsV1beta1StatefulSet };
