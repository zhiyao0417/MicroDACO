...
import { addSchema } from "../../_schemas/IoK8sApiFlowcontrolV1beta3FlowSchema.mjs";
/**
...
setSchema(FlowSchema, "io.k8s.api.flowcontrol.v1beta3.FlowSchema", addSchema);
export { FlowSchema as IoK8sApiFlowcontrolV1beta3FlowSchema };
