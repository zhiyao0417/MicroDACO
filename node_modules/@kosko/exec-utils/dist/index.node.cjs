...
function spawn(command, args = [], options = {}) {
    let proc = crossSpawn__default.default(command, args, options), stdoutChunks = [], stderrChunks = [];
    return options.input && (assert__default.default(proc.stdin), proc.stdin.end(options.input)), proc.stdout?.on("data", (chunk)=>{
...
exports.stringArrayArg = stringArrayArg;
